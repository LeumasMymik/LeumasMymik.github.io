...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<pre>$ lsb_release -a<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No LSB modules are available.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Distributor ID: Ubuntu<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Description:    Ubuntu 18.04.5 LTS<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Release:        18.04<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Codename:       bionic</pre></p>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<pre>$ sudo apt-add-repository ppa:brightbox/ruby-ng<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ sudo apt-get update<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ sudo apt-get install ruby2.5 ruby2.5-dev build-essential dh-autoreconf</pre></p>
