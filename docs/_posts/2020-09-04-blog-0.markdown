...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>$ lsb_release -a <br>No LSB modules are available. <br>Distributor ID: Ubuntu <br>Description:    Ubuntu 18.04.5 LTS <br>Release:        18.04 <br>Codename:       bionic</code></p>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>$ sudo apt-add-repository ppa:brightbox/ruby-ng <br>$ sudo apt-get update <br>$ sudo apt-get install ruby2.5 ruby2.5-dev build-essential dh-autoreconf</code></p>
