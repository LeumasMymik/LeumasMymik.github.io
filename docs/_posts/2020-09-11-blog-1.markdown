...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>$ apt-get install -y php libapache2-mod-php php-mysql php7.2-cli php7.2-curl php7.2-gd php7.2-mbstring php7.2-mysql php7.2-xml php-xml</code></p>
...
<code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$ apt-get install -y php libapache2-mod-php php-mysql php-cli php-curl php-gd php-mbstring php-mysql php-xml php-xml</code>
