...
<p>To get started with creating an AWS Educate Account, you are first going to have to sign up for a regular AWS account, which you can do at this link <a href="https://aws.amazon.com/resources/create-account/">here</a> and you can go ahead and follow this <a href="https://aws.amazon.com/premiumsupport/knowledge-center/create-and-activate-aws-account/">guide</a> to create and activate your account.</p>

<p>Once you have your AWS account ready, you can go ahead and use this <a href="https://www.awseducate.com/registration#APP_TYPE">link</a> to apply for an AWS Educate account. Filling out the application should be fairly straight forward once you select one of the following roles:</p>
<pre>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Roles:<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Educator<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;US Veteran<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Institution<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Company/Recruiter</pre>
