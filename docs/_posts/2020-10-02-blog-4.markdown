...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN apt-get install -y git &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;curl &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;apache2 &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zip &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN apt-get install -y mysql-client<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ARG DEBIAN&lowbar;FRONTEND=noninteractive<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN apt-get install -y php &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;libapache2-mod-php &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;php-mysql &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;php7.2-cli &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;php7.2-curl &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;php7.2-gd &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;php7.2-mbstring &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;php7.2-mysql &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;php7.2-xml &bsol;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;php-xml &bsol;</pre>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN git clone <a href="https://github.com/csuntechlab/affinity.git">https://github.com/csuntechlab/affinity.git</a><br></pre>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WORKDIR "/var/www/html"<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN git clone <a href="https://github.com/csuntechlab/affinity.git">https://github.com/csuntechlab/affinity.git</a><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN chown -hR www-data:www-data affinity/<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN git clone <a href="https://github.com/csuntechlab/affinity.git">https://github.com/csuntechlab/affinity.git</a><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN chown -hR www-data:www-data affinity/<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN ["ln", "-s", "/var/www/html/affinity/public", "public"]<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RUN sed -ri -e 's#DocumentRoot /var/www/html#DocumentRoot /var/www/html/public#' /etc/apache2/sites-available/000-default.conf<br>
